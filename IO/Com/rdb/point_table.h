...
enum yx_e {
    /* 起始地址0x0001 */
    device_status_yx =0,                       //0x0001	装置状态
    TEV1_alarm_yx,                             //0x0002	TEV1告警
    TEV2_alarm_yx,                             //0x0003	TEV2告警
    AA_alarm_yx,                               //0x0004	AA告警
    HFCT1_alarm_yx,                            //0x0005	HFCT1告警
    HFCT2_alarm_yx,                            //0x0006	HFCT2告警
    measure_end_yx,
...
/* 起始地址0x4001 */
    ...
    //读
    TEV1_amplitude_yc = 0,			            //0x4001	TEV1幅值
    ...
    HFCT1_noise_biased_adv_yc,                 //0x4010	HFCT1噪声偏置建议值
    HFCT2_amplitude_yc,                        //0x4011	HFCT2幅值
    HFCT2_num_yc,                              //0x4012	HFCT2脉冲个数
    HFCT2_severity_yc,                         //0x4013	HFCT2严重度
    HFCT2_center_biased_adv_yc,                //0x4014	HFCT2中心偏置建议值
    HFCT2_noise_biased_adv_yc,                 //0x4015	HFCT2噪声偏置建议值

    UHF1_amplitude_yc,                         //0x4016	UHF1幅值
    UHF1_num_yc,                               //0x4017	UHF1脉冲个数
    UHF1_severity_yc,                          //0x4018	UHF1严重度
    UHF1_center_biased_adv_yc,                 //0x4019	UHF1中心偏置建议值
    UHF1_noise_biased_adv_yc,                  //0x401a	UHF1噪声偏置建议值
    UHF2_amplitude_yc,                         //0x401b	UHF2幅值
    UHF2_num_yc,                               //0x401c	UHF2脉冲个数
    UHF2_severity_yc,                          //0x401d	UHF2严重度
    UHF2_center_biased_adv_yc,                 //0x401f	UHF2中心偏置建议值
    UHF2_noise_biased_adv_yc,                  //0x4020	UHF2噪声偏置建议值

    AA1_amplitude_yc,                           //0x4021	AA1幅值
    AA1_num_yc,								 //			AA1脉冲个数
    AA1_severity_yc,                            //0x4022	AA1严重度
    AA1_noise_biased_adv_yc,                    //0x4023	AA1噪声偏置建议值
    AA2_amplitude_yc,                           //0x4024	AE2幅值
    AA2_num_yc,							 	 //			AA2脉冲个数
    AA2_severity_yc,                            //0x4025	AE2严重度
    AA2_noise_biased_adv_yc,                    //0x4026	AE2噪声偏置建议值

    AE1_amplitude_yc,                           //0x4027	AE1幅值
    AE1_num_yc,							 	 //			AE1脉冲个数
    AE1_severity_yc,                            //0x4028	AE1严重度
    AE1_noise_biased_adv_yc,                    //0x4029	AE1噪声偏置建议值
    AE2_amplitude_yc,                           //0x402a	AE2幅值
    AE2_num_yc,							 	 //			AE2脉冲个数
    AE2_severity_yc,                            //0x402b	AE2严重度
    AE2_noise_biased_adv_yc,                    //0x402c	AE2噪声偏置建议值
