...
//    height: keyboardBackground.height + (VirtualKeyboardSettings.wordCandidateList.alwaysVisible ? wordCandidateView.height : 0)
    height: keyboardBackground.height + wordCandidateView.height
    onActiveChanged: {
        hideLanguagePopup()
    ...
    Binding {
        ...
        value: Qt.rect(keyboard.x,
                       keyboard.y + wordCandidateView.currentYOffset,
                       keyboard.width,
                       keyboard.height - wordCandidateView.currentYOffset)
    ...
    SelectionControl {
        ...
        anchors.top: wordCandidateView.top
        anchors.left: wordCandidateView.left
...
//        height: Math.round(style.selectionListHeight)
        height: keyboardBackground.height / 5
