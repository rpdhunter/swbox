...
void TTKToggleTrack::paintEvent(QPaintEvent *event)
{
    ...
    if(Qt::Horizontal == m_toggle->orientation())
    {
//        const int h = height() * 3/4;
//        const QRect r(0, height()/8, width(), h);
//        painter.drawRoundedRect(r.adjusted(14, 4, -14, -4), h/2-4, h/2-4);
//        setStyleSheet("QLabel{color:#0EC3FD;}");r;
...
//    setMinimumSize(20,15);
    setMaximumSize(34,16);
//    setDisabledColor("#CACACA");
//    setActiveColor("#4EFF67");
    setActiveColor(Qt::green);
    setInactiveColor("#CACACA");
    setTrackColor("#CACACA");
